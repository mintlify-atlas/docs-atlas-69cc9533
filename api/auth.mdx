...
description: "Reference for auth.php: POST login with credentials, GET session status check, and POST logout. Admin loan routes require an active PHP session cookie."
---
