...
description: "How to set correct Apache file ownership, secure api/config.php, configure SELinux write contexts for the sessions directory, and use fix_auth.sh on CentOS 9."
---
